...
All notable changes to DataSmith are documented here.
...
**CLI**
- `datasmith run config.yaml [--dry-run]` — YAML-driven pipeline execution
- `datasmith assess` — data quality reporting (JSON/Markdown/HTML)
- `datasmith benchmark` — MT-Bench lite, IF-Eval lite, Safety lite
