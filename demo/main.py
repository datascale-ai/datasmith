...
from datasmith import Pipeline, EvolInstruct, RegexFilter
from datasmith.clients import OpenAIClient
...
async def main() -> None:
    parser = argparse.ArgumentParser(description="DataSmith 端到端演示")
    parser.add_argument(
        "--backend",
