# src/datasmith/config/loader.py
...
from datasmith.config.schema import (
    EvaluateStepConfig,
    ForgeConfig,
    GenerateStepConfig,
    LLMConfig,
...
from datasmith.registry import get_evaluator, get_strategy
...
def build_strategy(step: GenerateStepConfig) -> BaseStrategy:
    ...
    import datasmith.strategies  # noqa: F401
...
def build_evaluator(step: EvaluateStepConfig) -> BaseEvaluator:
    ...
    import datasmith.dedup  # noqa: F401
    import datasmith.evaluators  # noqa: F401
...
def build_pipeline(config: ForgeConfig) -> tuple[Pipeline, str, str, int]:
    ...
    if config.source.type != "jsonl":
        from datasmith.io import read_records, write_jsonl_records
