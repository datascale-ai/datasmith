# src/datasmith/distributed/coordinator.py
...
from datasmith.engine.redis_checkpoint import RedisCheckpointManager
from datasmith.metrics import PipelineResult
from datasmith.schema import RecordStatus
...
def _import_redis():
    try:
        ...
        raise ImportError(
            ...
            "Install it with: pip install 'datasmith[distributed]'"
        ) from None
...
class Coordinator:
    ...
    def __init__(
        ...
        run_id: str = "default",
        queue_name: str = "datasmith:tasks",
        result_channel: str = "datasmith:results",
    ) -> None:
