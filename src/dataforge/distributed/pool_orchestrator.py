# src/datasmith/distributed/pool_orchestrator.py
"""Orchestrator for the DataSmith persistent worker pool.
...
from datasmith.distributed.pool_worker import _READY_FILE, _SHUTDOWN_SENTINEL, _worker_main
