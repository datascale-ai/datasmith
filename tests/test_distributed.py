...
from datasmith.config.schema import DistributedConfig, ForgeConfig
...
class TestRedisCheckpointImport:
    ...
    def test_import_error_message(self) -> None:
        ...
        from datasmith.engine.redis_checkpoint import _import_redis
...
class TestRedisRateLimiterImport:
    ...
    def test_import_error_message(self) -> None:
        from datasmith.engine.redis_rate_limiter import _import_redis
        try:
            _import_redis()
        except ImportError as e:
            assert "pip install" in str(e)
