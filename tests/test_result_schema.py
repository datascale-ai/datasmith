...
def test_aggregate_numeric_results_handles_single_and_multi_runs():
    rows = aggregate_numeric_results(
        [
            {"method": "datasmith", "provider": "deepseek", "effective_records_per_minute": 10.0},
            {"method": "datasmith", "provider": "deepseek", "effective_records_per_minute": 14.0},
    ...
    assert lookup[("deepseek", "datasmith")]["effective_records_per_minute_mean"] == 12.0
