  ...
  <section class="hero-carousel" aria-label="hero">
    ...
    <div class="hero-content container">
      ...
      <div class="hero-badges">
        <a href="https://github.com/datascale-ai/datasmith" target="_blank" rel="noopener">
          <img src="https://img.shields.io/github/stars/datascale-ai/datasmith?style=social" alt="GitHub Stars" />
        </a>
      ...
      <div class="hero-actions">
        ...
        <a
          href="https://github.com/datascale-ai/datasmith"
          target="_blank"
          rel="noopener"
          class="btn btn-ghost"
        >
      ...
      <div class="install-block" @click="copyInstall">
        <code>pip install datasmith</code>
...
function copyInstall() {
  navigator.clipboard.writeText('pip install datasmith').then(() => {
    copied.value = true
