export default {
  ...
  home: {
    hero: {
      title: 'DataSmith',
      subtitle: 'LLM 时代的高并发数据合成引擎',
      slogan: '提供种子数据，我们为你合成丰富+高质量的海量数据集',
      cta_start: '快速开始',
      cta_github: 'Github',
      install_tip: '点击复制',
      install_copied: '已复制！',
    ...
    overview: {
      title: 'DataSmith 是什么',
      body: '大规模构建 SFT/RLHF 数据集，首先是一个基础设施问题，其次才是数据问题。朴素的异步脚本会悄悄触达速率限制、在没有检查点的情况下崩溃、生成格式错误的输出，并且没有任何审计记录。当记录数超过 1 万条时，这些问题会相互叠加——在进度 80% 时崩溃，意味着损失数小时的 API 费用，并且需要从头开始。\n\n DataSmith 是一个生产级异步流水线，自动处理速率限制、重试、检查点和质量过滤——让你专注于生成什么数据，而不是如何生成。无论你使用云端 API 还是本地 vLLM 服务器，它的工作方式完全一致。',
    },
    highlights: {
      title: '核心特性',
      items: [
  ...
  news: {
    ...
    items: [
      {
        date: '2026-04-17',
        title: 'DataSmith 官网正式上线',
        desc: '官方网站上线，支持中英双语，涵盖项目介绍、研究方向、论文发表、资源下载与团队信息。',
      },
      {
        date: '2026-03-20',
        title: 'DataSmith v1.0 MVP 正式发布',
  ...
  team: {
    title: '团队成员',
    subtitle: '来自学术界与工业界的研究者共同推动 DataSmith 的发展。',
    members: [
